    ...
    <div class="payinput">
      <div class="payinput-container">
        ...
        <div class="payremark">
          ...
          <div class="remark-close icon-position" :style="{backgroundImage: 'url(\''+ imgCloseBg +'\')'}" @click="clearRemark" v-if="remark"></div>
        </div>
      </div>
      <div class="paybtns btnsblue mt40 justcenter" @click="turnToPay"><span>付款</span></div>
      <!--弹窗提示-->
      ...
      <div class="lf-pay-panel" style="height: 10rem;">
        <div>
          ...
          <div class="two" :class="equipmentId?'disabledinput':''">
            ...
            <input class="text-lg pay-price-input" style="padding: 0.1875rem 0.3125rem;" type="number" v-model="payMoney" ref="inputRef">
          </div>
          <div class="three">
...
<script>
import {getWebPay, getMerchantName, getStoreName, baseURL} from '../../../api/vueAPI.js'
    ...
    mounted() {
      ...
      */
      ...
      showTips(text) {
        ...
        let equipmentId = initParams(this.$route.query.equipmentId)
        let fromWhere = initParams(this.$route.query.fromWhere)
        ...
        let  timestramp = sessionStorage.getItem('timestramp')
				getWebPay(payWay, this.payMoney, this.userId, this.storeId, uuid, equipmentId, this.remark, md5Str, timestramp, this.goodsOrderId, this.hbFqNum).then(res => {
